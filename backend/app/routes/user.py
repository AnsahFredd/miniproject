...
from app.services.user_profile_service import UserProfileService, UserStatsService
...
async def get_user_activity_stats(current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        result = await UserProfileService.get_activity_stats(current_user)
...
async def get_user_notifications(
    ...
    try:
        ...
        result = await UserProfileService.get_user_notifications(current_user, limit)
...
async def get_user_recent_activity(
    ...
    try:
        ...
        result = await UserProfileService.get_recent_activity(current_user, limit)
...
async def get_ai_summary(current_user: User = Depends(get_current_user)):
    ...
    try:
        ...
        result = await UserProfileService.get_ai_summary(current_user)
